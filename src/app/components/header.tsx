    ...
    return (
        ...
        {/* mobile dropdown */}
            <details className="dropdown dropdown-bottom dropdown-left mr-10 lg:hidden">
                ...
                <ul className="p-2 shadow dropdown-content z-[1]  border border-solid border-zinc-500 rounded-2xl backdrop-blur bg-base-100 bg-opacity-75">
                    <a className="btn btn-ghost text-2xl "> juegos </a>
                    <a className="btn btn-ghost text-2xl "> skills </a>
                    <a className="btn btn-ghost text-2xl "> certifications </a>
                    <a className="btn btn-ghost text-2xl "> projectos </a>
                    <a className="btn btn-ghost text-2xl "> contatos </a>
                    <div className="ml-20">
                        <label className="swap swap-rotate">

                            {/* this hidden checkbox controls the state */}
                            <input type="checkbox" className="theme-controller" value="zerowhite" />
